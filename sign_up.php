                                ...
                                <form>
                                    <div class="input">
                                        <div class="phone-number">
                                            <input class="input-phone" type="text" placeholder="Số điện thoại" autocomplete="tel" name="phone" aria-invalid="false">
                                        </div>
                                    </div>
                                    <div id="phone-error" aria-live="polite"></div>
                                    <div class="line-or">
                                        <div class="p__MPF"></div>
                                        <span class="MPD">hoặc</span>
                                        <div class="p__MPF"></div>
                                    </div>
                                    <div class="input2">
                                        <div class="email">
                                            <input class="input-email" type="email" placeholder="Email" autocomplete="tel" name="email" aria-invalid="false">
                                        </div>
                                        <div id="email-error" aria-live="polite"></div>
                                    </div>
                                    <button class="creat" type="submit">Tiếp theo</button>
                                </form>
                            </div>
